...
const translations = {
  ...
  "onb.permissionsDesc": { en: "Brava needs Accessibility permission to use global keyboard shortcuts and monitor your clipboard. This data stays on your device.", he: "Brava צריכה הרשאת נגישות כדי להשתמש בקיצורי מקלדת גלובליים ולנטר את הלוח שלך. המידע נשאר במכשיר שלך." },
  "onb.openPermissions": { en: "Open System Preferences", he: "פתח את העדפות המערכת" },
