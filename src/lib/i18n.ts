...
const translations = {
  ...
  "set.wrongLayoutMode": { en: "Wrong Layout Action", he: "פעולה בזיהוי פריסה שגויה" },
  "set.wrongLayoutPopup": { en: "Show popup suggestion", he: "הצג הצעה בפופאפ" },
  "set.wrongLayoutAutofix": { en: "Auto-fix silently", he: "תקן אוטומטית בשקט" },
  "set.wrongLayoutOff": { en: "Off (don't detect)", he: "כבוי (אל תזהה)" },
  ...
  "onb.welcomeTagline": { en: "Your productivity toolkit for smart keyboard layout conversion, clipboard management, and AI-powered text tools.", he: "ערכת הכלים שלך להמרת פריסת מקלדת חכמה, ניהול לוח, וכלי טקסט מונעי AI." },
  "onb.letsSetup": { en: "Let's set up your permissions", he: "בואו נגדיר את ההרשאות שלך" },
  "onb.perm.accessibilityTitle": { en: "Accessibility Access", he: "גישת נגישות" },
  "onb.perm.accessibilityWhy": { en: "Brava needs Accessibility access to detect your keyboard input globally and register hotkeys.", he: "Brava צריכה גישת נגישות כדי לזהות את הקלדתך באופן גלובלי ולרשום קיצורי מקלדת." },
  "onb.perm.accessibilityFeatures": { en: "Global keyboard shortcuts, Real-time layout detection, Text conversion from any app", he: "קיצורי מקלדת גלובליים, זיהוי פריסה בזמן אמת, המרת טקסט מכל אפליקציה" },
  "onb.perm.screenRecordingTitle": { en: "Screen Recording Access", he: "גישת הקלטת מסך" },
  "onb.perm.screenRecordingWhy": { en: "Brava needs Screen Recording access to capture screenshots of your screen.", he: "Brava צריכה גישת הקלטת מסך כדי לצלם את המסך שלך." },
  "onb.perm.screenRecordingFeatures": { en: "Screenshot capture, Screen annotation tools, Region selection", he: "צילום מסך, כלי אנוטציה, בחירת אזור" },
  "onb.perm.automationTitle": { en: "Automation Access", he: "גישת אוטומציה" },
  "onb.perm.automationWhy": { en: "Brava needs Automation access to convert text directly in other applications.", he: "Brava צריכה גישת אוטומציה כדי להמיר טקסט ישירות באפליקציות אחרות." },
  "onb.perm.automationFeatures": { en: "Convert selected text with Cmd+Shift+T, Auto-paste converted text, Works in any app", he: "המר טקסט מסומן עם Cmd+Shift+T, הדבקה אוטומטית של טקסט מומר, עובד בכל אפליקציה" },
  "onb.perm.automationNote": { en: "macOS will ask you to confirm when you first use this feature.", he: "macOS יבקש ממך לאשר בפעם הראשונה שתשתמש בתכונה זו." },
  "onb.perm.skipWarning": { en: "Some features may not work without this permission.", he: "חלק מהתכונות עלולות לא לעבוד ללא הרשאה זו." },
  "onb.perm.grantButton": { en: "Open System Settings", he: "פתח הגדרות מערכת" },
  "onb.perm.grantedLabel": { en: "Permission Granted", he: "ההרשאה אושרה" },
  "onb.perm.continueButton": { en: "Continue", he: "המשך" },
  "onb.perm.skipButton": { en: "Skip for now", he: "דלג לעת עתה" },
  "onb.allSet.subtitle": { en: "Here's your permission status:", he: "הנה סטטוס ההרשאות שלך:" },
  "onb.allSet.granted": { en: "Granted", he: "מאושר" },
  "onb.allSet.skipped": { en: "Skipped", he: "דולג" },
  "onb.allSet.openSettings": { en: "Open Settings", he: "פתח הגדרות" },
  "onb.screenshotTitle": { en: "Screenshot Capture", he: "צילום מסך" },
  "onb.screenshotDesc": { en: "Capture any region of your screen with annotations. Draw arrows, rectangles, blur sensitive info, and more.", he: "צלם כל אזור במסך שלך עם אנוטציות. צייר חצים, מלבנים, טשטש מידע רגיש, ועוד." },
  "onb.screenshotDetail": { en: "Use Cmd+Shift+S to capture a screenshot.", he: "השתמש ב-Cmd+Shift+S לצילום מסך." },
